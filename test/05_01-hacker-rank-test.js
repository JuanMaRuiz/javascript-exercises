...
describe('Mark and Toys', function () {
    describe("Write a JavaScript program to test how many toys can buy for a given amount", function () {
        it("should return 4 toys", function () {
        ...
        it("should return 2 toys", function () {
